...
/**
 * Seek backward in the current track by the configured step size.
 */
export default async function Command() {
  try {
    ...
    const lastZoneId = await ZonePersistenceService.getLastZone("seek-backward");
    ...
    await ZonePersistenceService.setLastZone("seek-backward", zone.zone_id);
